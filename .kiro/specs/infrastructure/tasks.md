...
- [x] 1. Docker Compose 環境構築
- [x] 1.1 全サービス定義と依存関係の設定
...
- [x] 2. Spring Boot + Kotlin スキャフォールド
- [x] 2.1 ビルド設定と Kotlin プラグイン設定
...
- [x] 3. (P) React + Tailwind CSS スキャフォールド
- [x] 3.1 フロントエンドプロジェクト初期化と設定
...
- [x] 4. ドメイン層: User エンティティと UserRepository インターフェース
- [x] 4.1 User エンティティ定義
...
- [x] 4.2 UserRepository インターフェース定義
...
- [x] 5. インフラ/永続化層: UserJpaRepository
- [x] 5.1 JPA リポジトリ実装
...
- [x] 6. (P) インフラ/Redis 層: TokenRedisRepository
- [x] 6.1 Redis トークン管理実装
...
- [x] 7. (P) インフラ/セキュリティ層: JwtTokenProvider
- [x] 7.1 JWT 発行・検証ロジック実装
...
- [x] 8. Spring Security 設定と JWT 認証フィルター
- [x] 8.1 JwtAuthenticationFilter 実装
...
- [x] 9. アプリケーション層: AuthService
- [x] 9.1 ログイン・登録ユースケース実装
...
- [x] 10. プレゼンテーション層: AuthController
- [x] 10.1 認証エンドポイント実装
